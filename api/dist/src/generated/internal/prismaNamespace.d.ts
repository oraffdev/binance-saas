...
export declare const BotScalarFieldEnum: {
    ...
    readonly tp: "tp";
    readonly sl: "sl";
    readonly useDynamicSLTP: "useDynamicSLTP";
    readonly atrMultiplier: "atrMultiplier";
    readonly tpSlRatio: "tpSlRatio";
    readonly isActive: "isActive";
    readonly autoTune: "autoTune";
    readonly lastTunedAt: "lastTunedAt";
    readonly tuneLookbackDays: "tuneLookbackDays";
